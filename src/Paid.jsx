...
function Paid() {
    return (
        <div className="min-h-screen p-5 text-white bg-gray-900 mt-">
          

            <div className="grid max-w-screen-xl grid-cols-1 gap-8 mx-auto mt-24 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="animate__animated animate__fadeInUp animate__delay-1s">
                    <div className="overflow-hidden transition-shadow duration-300 bg-gray-800 rounded-lg shadow-lg hover:shadow-2xl">
                        ...
                        <div className="p-6">
                            ...
                            <Link to="/pi" className="inline-block px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700">Learn More</Link>
                        </div>
                    </div>
                </div>
